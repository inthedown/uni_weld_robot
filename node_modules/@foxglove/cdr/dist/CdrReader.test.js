...
describe("clone()", () => {
    it("creates an independent reader with the same state", () => {
        const writer = new CdrWriter_1.CdrWriter({
            kind: _1.EncapsulationKind.CDR2_LE,
        });
        writer.int32(42);
        writer.float64(2.67);
        const reader = new CdrReader_1.CdrReader(writer.data);
...
describe("limit()", () => {
    ...
    it("can read and write present flags when using CDR2", () => {
        const writer = new CdrWriter_1.CdrWriter({ kind: _1.EncapsulationKind.CDR2_LE });
    ...
    it("can't read present flags when using CDR1", () => {
        const writer = new CdrWriter_1.CdrWriter({ kind: _1.EncapsulationKind.CDR_LE });
    ...
    it("can seek to end of the buffer", () => {
        const writer = new CdrWriter_1.CdrWriter({ size: 8 });
        writer.int32(1);
        const reader = new CdrReader_1.CdrReader(writer.data);
