...
const ros2idl_parser_1 = require("@foxglove/ros2idl-parser");
...
describe("MessageReader", () => {
    ...
    ])("should deserialize %s correctly based on specified time type", (msgDef, arr, expected, ros1Expected) => {
        const buffer = Uint8Array.from([0, 1, 0, 0, ...arr]);
        expect(new MessageReader_1.MessageReader((0, rosmsg_1.parse)(msgDef, { ros2: true })).readMessage(buffer)).toEqual(expected);
        expect(new MessageReader_1.MessageReader((0, rosmsg_1.parse)(msgDef, { ros2: true }), {
            timeType: "sec,nanosec",
        }).readMessage(buffer)).toEqual(expected);
        expect(new MessageReader_1.MessageReader((0, rosmsg_1.parse)(msgDef, { ros2: true }), {
            timeType: "sec,nsec",
        }).readMessage(buffer)).toEqual(ros1Expected);
    });
